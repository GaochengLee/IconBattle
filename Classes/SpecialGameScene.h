#ifndef __SPECIALGAMESCENE_SCENE_H__
#define __SPECIALGAMESCENE_SCENE_H__
...
class SpecialGameScene : public cocos2d::Scene
{
public:
	...
	CREATE_FUNC(SpecialGameScene);
	static void runCommand(SpecialGameScene* s, string command);

private:

	static const int BOARD_SIZE = 10;
	static const int SWAP_COUNT = 10;
	...
	void showScoreA(int,int,pii);

	void addScoreA(int,int);
...
#pragma region CONST_STRING
	...
	//cover
	const string PICTURE_COVER_PATH = "../Resources/texture/GameScene/game_background_special.png";
...
#pragma region NORMAL_NODE
	...
	/*红蓝宝石图片*/
	ImageView* PicRedGem;
	ImageView* PicBlueGem;
	Button* BtnBarBack;
	/*红蓝宝石分数条*/
	Slider* SliderRedScore;
	Slider* SliderBlueScore;
	//ui::EditBox* EditBoxSwap;
	Label* LabScore[2];
	Label* LabSwap;
	Button* BtnSetting;
	Button* BtnRankList;
...
#endif // __SPECIALGAMESCENE_SCENE_H__
